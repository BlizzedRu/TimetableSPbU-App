...
import kotlinx.android.synthetic.main.fragment_student_groups_selection.*
...
class StudentGroupsSelectionFragment : BaseFragment<NavigationActivity>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addButton.setOnClickListener {
            hostActivity.navigation.navigate(R.id.action_studentGroupsSelection_to_facultiesSearch)
        }
